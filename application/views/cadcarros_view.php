        ...
        <div id="main_content">        
            <div id="form_register">            
                ...
                <div id="name_content">
                    ...
                    <input type="text" class="gp-input-text-25 gp-150" name="total_juros_mes" readonly id="total_juros_mes" placeholder="" maxlength="20">
                    <div id="confpasswd_msg"></div>
                </div>                
                <div id="surname_content">
                    <span id="form_label">
                    <label>Total do parcelamento com 0,7%</label></span>
                    <input type="text" class="gp-input-text-25 gp-150" readonly name="total_juros" id="total_juros" placeholder="" maxlength="20">
                    <div id="confpasswd_msg"></div>
                </div>
